...
public class Programs {
    ...
    public static Program progMinimo = new Program("Prog Mínimo", new Word[] {
    ...
    public static Program fibonacci10 = new Program("Fibonacci10", new Word[] { // mesmo que prog exemplo, so que usa r0
                                                                                // no lugar de r8
    ...
    public static Program fatorial = new Program("Fatorial", new Word[] { // este fatorial so aceita valores positivos.
                                                                          // nao pode ser zero
            // linha coment
    ...
    public static Program pa = new Program("PA", new Word[] { new Word(Opcode.LDI, 2, -1, 1), // r2 = 1
            ...
            new Word(Opcode.LDI, 6, -1, 17), // armazena em r6 o endereco do fim do programa caso o numero (n) seja
                                             // invalido
            new Word(Opcode.JMPIL, 6, 5, -1), // se r5 < 0 vai para o endereco do fim do programa caso o numero (n) seja
    ...
    public static Program pb = new Program("PB", new Word[] { new Word(Opcode.LDI, 2, -1, 1), // r2 = 1
            ...
            new Word(Opcode.LDI, 6, -1, 10), // armazena em r6 o endereco do fim do programa caso o numero (n) seja
                                             // invalido
            new Word(Opcode.JMPIL, 6, 5, -1), // se r5 < 0 vai para o endereco do fim do programa caso o numero (n) seja
                                              // invalido, armazenado em r6
    ...
    public static Program pc = new Program("PC", new Word[] {
            ...
            new Word(Opcode.LDI, 1, -1, 17), // colocando o valor 5 na posicao 60 da memoria, porem vamos considerar
                                             // como [0]
            ...
            new Word(Opcode.SUB, 4, 5, -1), // sendo r4 j e r5 j+1, se o resultado for positivo, deve ser trocado (3-2=1
                                            // (swap), 1-3=-2)
            ...
            new Word(Opcode.LDD, 4, -1, 47), new Word(Opcode.SUB, 4, 3, -1), new Word(Opcode.LDI, 5, -1, 21), // passa
                                                                                                              // para r5
                                                                                                              // a
                                                                                                              // posicao
                                                                                                              // do
            ...
            new Word(Opcode.JMPIG, 5, 4, -1), // se r4>0 entao vetor ainta possui numeros, entao voltar p/ incio do for
                                              // de I na var r5
            new Word(Opcode.STOP, -1, -1, -1),
    ...
    public static Program testOut = new Program("Test Out",
            new Word[] { new Word(Opcode.LDI, 7, -1, 2), new Word(Opcode.LDI, 8, -1, 6),
                    new Word(Opcode.LDI, 1, -1, 800), new Word(Opcode.STD, 1, -1, 6), new Word(Opcode.TRAP, -1, -1, -1),
                    new Word(Opcode.STOP, -1, -1, -1),
