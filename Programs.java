...
public class Programs {
    ...
    public static Program progMinimo = new Program("Prog Mínimo",
        new Word[] {
    ...
    public static Program fibonacci10 = new Program("Fibonacci10",
    ...
    public static Program fatorial = new Program("Fatorial",
        new Word[] { 	 // este fatorial so aceita valores positivos.   nao pode ser zero
            // linha   coment
    ...
    public static Program pa = new Program("PA",
        new Word[] {
    ...
    public static Program pb = new Program("PB",
        new Word[] {
            new Word(Opcode.LDI, 2, -1, 1), // r2 =  1
    ...
    public static Program pc = new Program("PC",
        new Word[] { 
